...
Source0  : https://sourceware.org/elfutils/ftp/0.190/elfutils-0.190.tar.bz2
Source1  : https://sourceware.org/elfutils/ftp/0.190/elfutils-0.190.tar.bz2.sig
...
%prep
%setup -q -n elfutils-0.190
cd %{_builddir}/elfutils-0.190
pushd ..
cp -a elfutils-0.190 build32
popd
pushd ..
cp -a elfutils-0.190 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699554227
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libasm-0.190.so
/V3/usr/lib64/libdw-0.190.so
/V3/usr/lib64/libelf-0.190.so
/usr/lib64/libasm-0.190.so
/usr/lib64/libasm.so.1
/usr/lib64/libdw-0.190.so
/usr/lib64/libdw.so.1
/usr/lib64/libelf-0.190.so
/usr/lib64/libelf.so.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libasm-0.190.so
/usr/lib32/libasm.so.1
/usr/lib32/libdw-0.190.so
/usr/lib32/libdw.so.1
/usr/lib32/libelf-0.190.so
